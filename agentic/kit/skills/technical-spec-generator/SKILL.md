...
Implementation specification/LLD, requirement-to-component mapping, contract/data changes, test plan, and open decisions. Write or update the artifact at `agentic/data/project-context/features/<work-item-id>/TECH-SPEC.md` (template: `agentic/kit/templates/tech-spec.md`).
