...
1. Copy `agentic/` from a reviewed kit revision, excluding local `runtime/state/`, `artifacts/`, and Python caches. Preserve the host project's README and existing project-specific rules.
